...
class Shader {
  constructor(options = {}) {
    ...
    this.borderRadius = options.borderRadius || '150px';
  ...
  /** 创建需要的各元素 svg -> defs -> filter -> feImage、feDisplacementMap */
  createElement() {
    // Create container
    ...
    this.container.style.cssText = `
      ...
      backdrop-filter: url(#${this.id}_filter) blur(0.25px) contrast(1.1) brightness(1.05) saturate(1.1);
      z-index: 9999;
      pointer-events: auto;
    `;
    // Create SVG filter
